...
**Calibration** paragraph naming the look-alike that is *not* a violation. The
`patterns` rules are refactoring targets: flag one only when the friction it removes
